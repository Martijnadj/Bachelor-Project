...
//cc -O3 -Wall -o loco-efa_example loco-efa_example.c -lm
//run using the following command:
//loco-efa_example cell_outline.csv
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
void ReadData(int ac,char *av[])
{
  ...
  K=0;
  fp=fopen(av[1],"r");
  while (fscanf(fp,"%lf,%lf",&contour[K].x,&contour[K].y) != EOF) {
...
void CalculateLOCOCoefficients()
{
  int i;
